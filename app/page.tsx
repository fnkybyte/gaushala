      ...
      <main className="pt-20 pb-16 md:pb-0">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
            <div className="max-w-2xl text-white">
              ...
              <h1 className="text-5xl md:text-7xl font-headline font-extrabold leading-tight mb-6">
                {t("hero.title")} <span className="text-primary-container underline decoration-secondary">{t("hero.titleHighlight")}</span>
              </h1>
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-[0_8px_32px_rgba(143,78,0,0.06)] border border-outline-variant/10 group hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="text-on-surface-variant font-headline font-semibold">{t("stats.cowsSheltered")}</div>
            </div>
            <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-[0_8px_32px_rgba(143,78,0,0.06)] border border-outline-variant/10 group hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="text-on-surface-variant font-headline font-semibold">{t("stats.dailyFeeding")}</div>
            </div>
            <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-[0_8px_32px_rgba(143,78,0,0.06)] border border-outline-variant/10 group hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="text-on-surface-variant font-headline font-semibold">{t("stats.monthlyExpense")}</div>
            </div>
            <div className="bg-surface-container-lowest p-8 rounded-3xl shadow-[0_8px_32px_rgba(143,78,0,0.06)] border border-outline-variant/10 group hover:-translate-y-2 transition-transform duration-300">
              <div className="w-14 h-14 bg-secondary-container rounded-2xl flex items-center justify-center text-on-secondary-container mb-6 group-hover:scale-110 transition-transform">
              ...
              <div className="text-on-surface-variant font-headline font-semibold">{t("stats.rescuedThisYear")}</div>
            </div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center gap-20">
            <div className="w-full md:w-1/2 relative">
              ...
              <div className="absolute -bottom-8 -right-8 bg-surface-container-lowest p-6 rounded-2xl shadow-lg z-20 max-w-[240px]">
                <p className="font-headline font-bold text-primary italic">{`"${t("about.quote")}"`}</p>
                <p className="text-sm text-on-surface-variant mt-2">— Swami Dayananda</p>
              </div>
            </div>
            <div className="w-full md:w-1/2">
              <h2 className="text-sm font-headline font-bold text-primary uppercase tracking-[0.2em] mb-4">{t("about.badge")}</h2>
              <h3 className="text-4xl md:text-5xl font-headline font-extrabold text-on-surface mb-8">{t("about.title")}</h3>
              ...
              <div className="flex items-center gap-6">
                ...
                <p className="text-sm font-bold text-on-surface">{t("about.volunteers")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-surface">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-sm font-headline font-bold text-primary uppercase tracking-[0.2em] mb-4">{t("donate.badge")}</h2>
              <h3 className="text-4xl md:text-5xl font-headline font-extrabold text-on-surface mb-6">{t("donate.title")}</h3>
              <p className="text-lg text-on-surface-variant">{t("donate.subtitle")}</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-surface-container-low p-10 rounded-3xl flex flex-col items-center text-center group hover:bg-primary-fixed transition-colors duration-500">
                ...
                <h4 className="text-2xl font-headline font-bold mb-2">{t("donate.feedCow")}</h4>
                <p className="text-on-surface-variant mb-6">{t("donate.feedCowDesc")}</p>
              ...
              <div className="bg-primary-container p-10 rounded-3xl flex flex-col items-center text-center scale-100 md:scale-105 shadow-2xl relative overflow-hidden">
                <div className="absolute top-0 right-0 p-4">
                  <span className="bg-white/20 text-on-primary-container px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">{t("donate.mostNeeded")}</span>
                </div>
                ...
                <h4 className="text-2xl font-headline font-bold mb-2 text-on-primary-container">{t("donate.medicalSupport")}</h4>
                <p className="text-on-primary-container/80 mb-6">{t("donate.medicalSupportDesc")}</p>
              ...
              <div className="bg-surface-container-low p-10 rounded-3xl flex flex-col items-center text-center group hover:bg-secondary-container transition-colors duration-500">
                ...
                <h4 className="text-2xl font-headline font-bold mb-2">{t("donate.monthlyCare")}</h4>
                <p className="text-on-surface-variant mb-6">{t("donate.monthlyCareDesc")}</p>
            ...
            <div className="bg-surface-container-highest rounded-3xl p-12 flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="flex-1">
                <h4 className="text-3xl font-headline font-extrabold mb-4">{t("donate.adoptTitle")}</h4>
                <p className="text-lg text-on-surface-variant mb-6">{t("donate.adoptDesc")}</p>
                <div className="flex items-center gap-4 text-primary font-headline font-bold">
                  <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                  </svg>
                  {t("donate.taxExemption")}
                </div>
              </div>
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="font-bold text-xs uppercase tracking-widest text-on-surface-variant">{t("donate.scanToPay")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
            <div>
              <h2 className="text-sm font-headline font-bold text-primary uppercase tracking-[0.2em] mb-4">{t("gallery.badge")}</h2>
              <h3 className="text-4xl font-headline font-extrabold text-on-surface">{t("gallery.title")}</h3>
            </div>
            <Link href="/gallery" className="text-primary font-headline font-bold flex items-center gap-2 hover:gap-4 transition-all">
              {t("gallery.viewAll")} <ArrowRight className="w-5 h-5" />
            </Link>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="col-span-2 row-span-2 group overflow-hidden rounded-3xl relative h-[400px] md:h-auto">
              ...
              <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-8">
                <span className="text-white font-headline font-bold text-xl">{t("gallery.mainShelter")}</span>
              </div>
            </div>
        ...
        <section className="py-24 bg-secondary/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h2 className="text-3xl font-headline font-bold text-on-surface mb-12">{t("testimonials.title")}</h2>
              <div className="space-y-8">
                ...
                <div className="flex items-center justify-center gap-4">
                  ...
                  <div className="text-left">
                    <p className="font-bold text-on-surface">{t("testimonials.author")}</p>
                    <p className="text-sm text-on-surface-variant">{t("testimonials.authorTitle")}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto">
          <div className="bg-secondary p-12 md:p-20 rounded-[3rem] text-center relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto">
              <h2 className="font-headline text-4xl md:text-5xl font-extrabold text-on-secondary mb-6">{t("cta.title")}</h2>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="bg-surface-container-high rounded-[3rem] overflow-hidden grid md:grid-cols-2">
              <div className="p-12 md:p-16 space-y-8">
                <h2 className="text-4xl font-headline font-bold text-on-surface">{t("contact.title")}</h2>
                <p className="text-on-surface-variant">{t("contact.hours")}</p>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-on-surface-variant">{t("contact.addressValue")}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <svg className="w-6 h-6 text-primary flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <div>
                      ...
                      <p className="text-on-surface-variant">{t("contact.phoneValue")}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <svg className="w-6 h-6 text-primary flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
              ...
              <div className="p-12 md:p-16 bg-surface-container-lowest">
                <h3 className="text-2xl font-headline font-bold mb-6">{t("contact.sendMessage")}</h3>
