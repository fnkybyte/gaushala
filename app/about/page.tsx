      ...
      <main className="pt-20">
        ...
        <section className="relative h-[614px] flex items-center overflow-hidden bg-surface-container-low">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <span className="uppercase tracking-[0.3em] text-primary font-bold text-sm mb-4 block">{t("aboutPage.badge")}</span>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="absolute -bottom-10 -right-10 bg-primary-container p-8 rounded-xl hidden lg:block editorial-shadow max-w-xs">
                ...
                <p className="mt-4 text-sm font-bold text-on-primary-container uppercase tracking-wider opacity-80">{t("aboutPage.founderQuoteAuthor")}</p>
              </div>
            </div>
            <div className="space-y-6">
              <h2 className="font-headline font-bold text-4xl text-on-surface">{t("aboutPage.founderBadge")}</h2>
              <p className="text-lg leading-relaxed text-on-surface-variant">
                {t("aboutPage.founderPara1")}
              </p>
              <p className="text-lg leading-relaxed text-on-surface-variant">
                {t("aboutPage.founderPara2")}
              </p>
              <div className="pt-4">
        ...
        <section className="bg-surface-container-low py-24 rounded-[3rem] mx-4 md:mx-8">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="font-headline font-extrabold text-4xl text-on-surface">{t("aboutPage.purposeTitle")}</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="md:col-span-2 bg-surface-container-lowest p-10 rounded-xl editorial-shadow flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="font-headline font-bold text-2xl text-on-surface mb-4">{t("aboutPage.missionTitle")}</h3>
                ...
                <div className="mt-8 grid grid-cols-2 gap-4">
                  <div className="bg-surface p-4 rounded-lg">
                    ...
                    <span className="text-xs uppercase font-bold tracking-widest text-on-surface-variant">{t("aboutPage.cowsSheltered")}</span>
                  </div>
                  <div className="bg-surface p-4 rounded-lg">
                    <span className="text-secondary font-extrabold text-2xl block">24/7</span>
                    <span className="text-xs uppercase font-bold tracking-widest text-on-surface-variant">{t("aboutPage.support247")}</span>
                  </div>
                </div>
              </div>
              <div className="bg-primary p-10 rounded-xl editorial-shadow text-on-primary flex flex-col justify-center">
                ...
                <h3 className="font-headline font-bold text-2xl mb-4">{t("aboutPage.visionTitle")}</h3>
        ...
        <section className="py-24 px-6 max-w-5xl mx-auto">
          <h2 className="font-headline font-extrabold text-4xl text-center mb-16">{t("aboutPage.timelineTitle")}</h2>
          <div className="space-y-12">
            <div className="flex gap-8 items-start relative">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl editorial-shadow flex-grow">
                <h4 className="font-bold text-on-surface text-lg">{t("aboutPage.timeline2008Title")}</h4>
                <p className="text-on-surface-variant mt-2">{t("aboutPage.timeline2008Desc")}</p>
              </div>
            </div>
            <div className="flex gap-8 items-start relative">
              <div className="w-24 text-right pt-1 flex-shrink-0">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl editorial-shadow flex-grow">
                <h4 className="font-bold text-on-surface text-lg">{t("aboutPage.timeline2014Title")}</h4>
                <p className="text-on-surface-variant mt-2">{t("aboutPage.timeline2014Desc")}</p>
              </div>
            </div>
            <div className="flex gap-8 items-start relative">
              <div className="w-24 text-right pt-1 flex-shrink-0">
              ...
              <div className="bg-surface-container-lowest p-6 rounded-xl editorial-shadow flex-grow">
                <h4 className="font-bold text-on-surface text-lg">{t("aboutPage.timeline2021Title")}</h4>
                <p className="text-on-surface-variant mt-2">{t("aboutPage.timeline2021Desc")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 bg-surface-container">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
              <div>
                <span className="uppercase tracking-widest text-secondary font-bold text-sm mb-4 block">{t("aboutPage.teamBadge")}</span>
                <h2 className="font-headline font-extrabold text-4xl text-on-surface">{t("aboutPage.teamTitle")}</h2>
              </div>
              <p className="max-w-md text-on-surface-variant">{t("aboutPage.teamSubtitle")}</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="group">
                ...
                <h4 className="font-headline font-bold text-xl text-on-surface">{t("aboutPage.teamMember1Name")}</h4>
                <p className="text-primary font-semibold text-sm">{t("aboutPage.teamMember1Role")}</p>
              </div>
              {/* Team Member 2 */}
              <div className="group">
                <div className="aspect-[4/5] overflow-hidden rounded-xl mb-4 relative">
                ...
                <h4 className="font-headline font-bold text-xl text-on-surface">{t("aboutPage.teamMember2Name")}</h4>
                <p className="text-primary font-semibold text-sm">{t("aboutPage.teamMember2Role")}</p>
              </div>
              {/* Team Member 3 */}
              <div className="group">
                <div className="aspect-[4/5] overflow-hidden rounded-xl mb-4 relative">
                ...
                <h4 className="font-headline font-bold text-xl text-on-surface">{t("aboutPage.teamMember3Name")}</h4>
                <p className="text-primary font-semibold text-sm">{t("aboutPage.teamMember3Role")}</p>
              </div>
              {/* Team Member 4 */}
              <div className="group">
                <div className="aspect-[4/5] overflow-hidden rounded-xl mb-4 relative">
                ...
                <h4 className="font-headline font-bold text-xl text-on-surface">{t("aboutPage.teamMember4Name")}</h4>
                <p className="text-primary font-semibold text-sm">{t("aboutPage.teamMember4Role")}</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 text-center max-w-4xl mx-auto">
          <h2 className="font-headline font-extrabold text-4xl text-on-surface mb-8">{t("aboutPage.joinTitle")}</h2>
